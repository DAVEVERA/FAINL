        ...
        <div className="px-5 py-4 border-t-4 border-black">
          {canProceed ? (
            <button
              ...
              className="w-full py-4 bg-black text-white font-black uppercase tracking-[0.4em] text-[10px] flex items-center justify-center gap-3 hover:scale-[1.02] active:scale-[0.98] transition-all"
            >
          ...
          <button
            type="button"
            onClick={onDismiss}
            className="w-full mt-2 py-2 font-black text-[10px] uppercase tracking-[0.3em] text-black/25 hover:text-black/50 transition-colors"
          >
            Annuleren
          </button>
        </div>
