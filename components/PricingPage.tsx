  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="text-center mb-16 md:mb-24">
        <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter mb-6 text-black dark:text-white">Neural Access Tiers</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
        ...
        <div className="space-y-10">
          <div className="flex items-center gap-6 mb-8">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter text-black dark:text-white">Standard Access</h2>
              <p className="text-[10px] font-black text-black/40 dark:text-white/40 uppercase tracking-widest mt-1">Managed Neural Consensus</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {PRICING.TURNS.map((pkg, idx) => (
              ...
              >
                ...
                <div className="text-4xl font-black mb-2 flex items-center gap-3 text-current">
        ...
        <div className="space-y-10">
          <div className="flex items-center gap-6 mb-8">
            ...
            <div>
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter text-black dark:text-white">BYO Experience</h2>
              <p className="text-[10px] font-black text-black/40 dark:text-white/40 uppercase tracking-widest mt-1">Orchestration Only Link</p>
            </div>
          </div>

          <div className="space-y-6">
            <div className="bg-white/40 dark:bg-zinc-900/40 border-4 border-black dark:border-white/20 p-8 rounded-[2rem] backdrop-blur-sm">
      ...
      <div className="mt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={i} className="p-10 bg-white dark:bg-zinc-900 border-4 border-black dark:border-white/20 rounded-[2rem] shadow-[12px_12px_0px_0px_rgba(0,0,0,0.05)] dark:shadow-[12px_12px_0px_1px_rgba(255,255,255,0.05)]">
            <item.icon className="w-10 h-10 mb-6 text-black dark:text-white" />
            <h3 className="text-xl font-black uppercase mb-4 tracking-tighter text-black dark:text-white">{item.title}</h3>
            <p className="text-sm font-bold text-black/50 dark:text-white/50 leading-loose">{item.desc}</p>
          </div>
        ))}
      </div>
    </div>
