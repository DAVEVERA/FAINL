...
const App: FC = () => {
  ...
  const [modelCount, setModelCount] = useState<3 | 5>(3);
  ...
  const handleStart = async () => {
    ...
    // Detect active nodes based on selection
                    ...
                    <div className="w-full relative">
                      ...
                      <div className="mt-8 w-full animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                          <div className="flex bg-zinc-100 dark:bg-zinc-800 p-1 rounded-xl border-2 border-black dark:border-white/10 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.1)]">
                            <button
                              onClick={() => setModelCount(3)}
                              className={`px-6 py-2 rounded-lg font-black text-[10px] uppercase tracking-[0.2em] transition-all ${modelCount === 3 ? "bg-black dark:bg-white text-white dark:text-black shadow-lg" : "text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white"}`}
                            >
                              Gebruik 3 Modellen
                            </button>
                            <button
                              onClick={() => setModelCount(5)}
                              className={`px-6 py-2 rounded-lg font-black text-[10px] uppercase tracking-[0.2em] transition-all ${modelCount === 5 ? "bg-black dark:bg-white text-white dark:text-black shadow-lg" : "text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white"}`}
                            >
                              Gebruik 5 Modellen
                            </button>
                          </div>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex -space-x-3">
                              {config.activeCouncil
                                ...
                                .map((m, i) => (
                                  <div
                                    key={m.id}
                                    className="w-10 h-10 rounded-full border-4 border-white dark:border-zinc-900 overflow-hidden bg-zinc-200 shadow-xl"
                                    style={{ zIndex: 10 - i }}
                                  >
                                    <img
                                      src={m.avatar}
                            ...
                            <span className="font-black text-[10px] uppercase tracking-widest text-black/40 dark:text-white/40">
                              {selectedModelIds.length} Nodes actief
                            </span>
                          </div>
                        </div>
                              ...
                              <button
                                ...
                                onClick={() => {
                                  if (isSelected) {
                                    ...
                                    selectedModelIds.length < modelCount
                                  ) {
                                    setSelectedModelIds((prev) => [
                                      ...prev,
                                      member.id,
                                ...
                                className={`flex flex-col items-center gap-3 p-4 rounded-xl border-2 transition-all ${isSelected ? "border-black dark:border-white bg-black/5 dark:bg-white/5 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)]" : "border-black/5 dark:border-white/5 grayscale opacity-40 hover:opacity-100 hover:grayscale-0 hover:border-black/20 dark:hover:border-white/20"}`}
                              >
                                <div className="w-12 h-12 rounded-lg overflow-hidden border-2 border-black/10 dark:border-white/10">
                                  <img
                                    src={member.avatar}
                                    alt={member.name}
                                    className="w-full h-full object-cover"
                                ...
                                <div className="text-center">
                                  <span className="block font-black text-[8px] uppercase tracking-tighter leading-none mb-1">
                                    {member.name}
                                  </span>
                                  <span className="block text-[7px] font-bold text-black/40 dark:text-white/40 uppercase tracking-widest">
                        ...
                        <p className="mt-8 text-[8px] md:text-[10px] font-black text-black/20 dark:text-white/20 uppercase tracking-[0.2em] block text-center">
              ...
              !authSession ? (
                ...
                <>
                  ...
                  <AccountPage
                    ...
                    onImportHistory={(newHistory) => setHistory(newHistory)}
                  />
                </>
              )
            }
